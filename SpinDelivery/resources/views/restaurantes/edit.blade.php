                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('restaurantes.update',$restaurante) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{$restaurante->nombre }}"   autocomplete="nombre" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" value="{{$restaurante->direccion }}"   autocomplete="direccion" autofocus>
