...
<html>
  ...
  <body class="sub_page">
    ...
    <div class="hero_area"><div class="bg-box">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <form action="{{ route('linea.store', $plato) }}" method="POST">
                @csrf
                <div class="row d-flex align-items-center">
                  ...
                  <div class="col-12 col-md-5">
                    <input
                      type="text" id="anotaciones" name="anotaciones"
                      class="form-control"
                      style="border-radius: 5px"
                  ...
                  <div class="col-12 col-md-4">
                    <input
                      type="submit" value="Añadir al pedido"
                      style="
              ...
              <div class="mt-3">
                <small
                  ><i class="fa-solid fa-hand-dots text-warning"></i
                  >&nbsp;&nbsp;Alérgenos:</small
                >
                <small>{{ $plato->alergenos }}</small>
                @if ($plato->es_vegano == 1)
                <br />
                <small
                  ><i class="fa-solid fa-leaf text-success"></i>&nbsp;&nbsp;Apto
                  para veganos</small
                >
                @endif
              </div>
